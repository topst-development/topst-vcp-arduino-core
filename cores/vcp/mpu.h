...
extern uint32_t _end_of_nc_dma;

/* CAN */
extern uint32_t __nc_canstart;
extern uint32_t _end_of_nc_can;
...
{
    uint32_t                              uiRegionEnable;
    uint32_t                              uiRegionBase;
    uint32_t                              uiRegionSize;
    uint32_t                              uiRegionAttr;
} MPUConfig_t;
...
*
* @param    none
* @return   uint32_t DMA Base Address.
*
* Notes
*
***************************************************************************************************
...
*
* @param    none
* @return   uint32_t CAN Message RAM Base Address.
*
* Notes
*
***************************************************************************************************
